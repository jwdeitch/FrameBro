...
Markup::before('div', 'file-manager', ['id' => 'file-manager']);
    WebForm::open('file_upload', 'file_upload', null, 'form-inline', TRUE, 'POST', 'Selecione archivo para subir');
        WebForm::before('div', 'col-md-7 col-md-offset-2');
            WebForm::before('div', 'form-group btn btn-info btn-file');
                WebForm::field('image', 'file', null, null, 'Explorar Archivos');
            WebForm::after();
            WebForm::before();
                WebForm::submit('Enviar');
            WebForm::after();
        WebForm::after();
    WebForm::close();
